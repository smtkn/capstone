#!/usr/bin/env python3
"""
Customer Type Analysis – RFM + K-Means · Hierarchical · DBSCAN
──────────────────────────────────────────────────────────────
Çıktılar (./output/):
  • rfm_kmeans.csv, rfm_hierarchical.csv, rfm_dbscan.csv
  • cluster_descriptions_<algo>.txt
  • 3-D scatter görseller (PNG)

K-Means & Hier k = 8      |   DBSCAN grid-search (eps 0.3-3.0, ms 3-8)
"""
